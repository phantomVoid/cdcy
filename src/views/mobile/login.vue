  ...
  <div class="login">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form">
      ...
      <el-form-item style="width:100%;">
        ...
        <div style="float: right;margin-top: 5px;color: #fff">还没有账号? <a href="/mobile/register" style="color: #ff9308">立即注册</a>
        </div>
      </el-form-item>
    </el-form>
  </div>
...
//  align-items: center;
//  height: 100%;
//  background: url(../../assets/mobile/images/login-bg.jpg) no-repeat;
